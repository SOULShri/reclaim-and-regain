...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      // Note: We don't navigate here because OAuth redirects the browser
    } catch (error: any) {
      console.error("Google login failed:", error);
      if (error.message.includes("not enabled")) {
        setError("Google login is not enabled. Please contact the administrator or use email login instead.");
      } else {
        setError("Google login failed. Please try again later or use email login.");
      }
